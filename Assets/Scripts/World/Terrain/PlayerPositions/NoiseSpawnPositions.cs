...
public class NoiseSpawnPositions
{
    public float[,] values;
    private int size;
    private NoiseSpawnPositionsSettings settings;
    public RawImage noiseDebug;
    private Edge edge;

    public NoiseSpawnPositions(int chunkSize, NoiseSpawnPositionsSettings settings, bool hasPlayerSpawn, Edge edge)
    {
        this.edge = edge;
        this.size = chunkSize;
