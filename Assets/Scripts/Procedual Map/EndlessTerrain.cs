...
public class EndlessTerrain : MonoBehaviour
{
    ...
    public class TerrainChunk
    {
        ...
        public TerrainChunk(Vector2 coord, float meshWorldSize, LODInfo[] detailLevels, int colliderLODIndex, Transform parent, Material material)
        {
            ...
            mapGenerator.RequestHeightMap(sampleCentre, OnHeightDataReceived);
        }

        void OnHeightDataReceived(HeightMap heightData)
        {
            ...
            if (heightDataReceived)
            {
                ...
                if (visible)
                {
                    ...
                    if (lodIndex != previousLODIndex)
                    {
                        ...
                        {
                            lodMesh.RequestMesh(heightData);
                        }
                    }
        ...
        public void UpdateCollisionMesh()
        {
            if (!hasSetCollider)
            {
                ...
                if (sqrDstFromViewerToEdge < detailLevels[colliderLODIndex].sqrVisibleDstThreshold)
                {
                    ...
                    {
                        lodMeshes[colliderLODIndex].RequestMesh(heightData);
                    }
                }
    ...
    class LODMesh
    {
        ...
        public void RequestMesh(HeightMap heightData)
        {
            hasRequestedMesh = true;
            mapGenerator.RequestMeshData(heightData, lod, OnMeshDataReceived);
        }
